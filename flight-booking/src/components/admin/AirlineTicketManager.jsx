...
const AirlineTicketManager = () => {
    ...
    const calculateSeatsFromRows = () => {
        if (!selectedAirline || !formData.row_start || !formData.row_end)
            return 0;
    ...
    const calculateRemainingSeats = () => {
        ...
        const totalCapacity =
            Number(selectedAirline.seat_rows) *
            Number(selectedAirline.seat_per_row);
                    ...
                    <div className="airline-list">
                        {airlines.map((al) => (
                            ...
                            >
                                ...
                                <br />
                                <small>
                                    Hàng ghế: {al.seat_rows} | Ghế/hàng:{" "}
                                    {al.seat_per_row}
                                </small>
                            </div>
                        ))}
                ...
                <div style={{ flex: 2 }}>
                    {selectedAirline ? (
                        <>
                            ...
                            >
                                Số ghế còn trống:{" "}
                                <strong>{calculateRemainingSeats()}</strong> /{" "}
                                {selectedAirline.seat_rows *
                                    selectedAirline.seat_per_row}
                            </div>
